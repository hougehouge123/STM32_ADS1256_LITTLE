...
//模拟SPI时钟引脚---输出
#define SCK_H  HAL_GPIO_WritePin(GPIOA ,GPIO_PIN_1,1)
#define SCK_L  HAL_GPIO_WritePin(GPIOA ,GPIO_PIN_1,0)

//模拟SPI数据输入引脚---输入
#define DOUT HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_4)

//模拟SPI数据输出引脚---输出
#define DIN_H  HAL_GPIO_WritePin(GPIOA ,GPIO_PIN_2,1)
#define DIN_L  HAL_GPIO_WritePin(GPIOA ,GPIO_PIN_2,0)

//模拟SPI片选引脚---输出
#define CS_H  HAL_GPIO_WritePin(GPIOA ,GPIO_PIN_3,1)
#define CS_L  HAL_GPIO_WritePin(GPIOA ,GPIO_PIN_3,0)

//ADS1256状态引脚---输入
#define DRDY	HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_5)
